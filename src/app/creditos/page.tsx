...
function CreditosInner() {
  ...
  const [deckIdx, setDeckIdx] = useState<number>(2);
            ...
            >
              ...
              <div className="relative flex flex-col items-center text-center">
                ...
                <button
                  ...
                  disabled={loginLoading}
                  className="group relative w-full flex items-center justify-center gap-3 py-4 px-6 transition-all disabled:opacity-50 disabled:cursor-wait focus:outline-none"
                  style={{
