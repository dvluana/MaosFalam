    ...
    >
      <html lang="pt-BR">
        ...
        >
          ...
          <Analytics />
          <Script
            src="https://www.googletagmanager.com/gtag/js?id=G-4VE6FX3BPX"
            strategy="afterInteractive"
          />
          <Script id="google-analytics" strategy="afterInteractive">
            {`window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-4VE6FX3BPX');`}
          </Script>
