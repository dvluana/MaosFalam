    ...
    >
      <html lang="pt-BR" className={cn("font-sans", dmSans.variable, loraHeading.variable)}>
        ...
        >
          ...
          <Analytics />
          <Script
            src="https://www.googletagmanager.com/gtag/js?id=G-0GPE6YFEHN"
            strategy="afterInteractive"
          />
          <Script id="google-analytics" strategy="afterInteractive">
            {`window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-0GPE6YFEHN');`}
          </Script>
