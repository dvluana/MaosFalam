...
- [ ] **PAY-01**: abacatepay.ts migrado pra API v2 — endpoints /v2/checkouts/create, /v2/customers/create; produtos referenciados por ID (nao inline)
- [ ] **PAY-02**: 4 produtos criados no AbacatePay (mf_avulsa, mf_dupla, mf_roda, mf_tsara) com externalId mapeado ao CREDIT_PACKS
- [ ] **PAY-03**: POST /api/credits/purchase chama createCheckout() v2 e retorna checkout_url do AbacatePay
...
- [ ] **PAY-06**: methods: ["PIX", "CARD"] no checkout (nao so PIX)
